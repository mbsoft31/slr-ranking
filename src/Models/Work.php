...
class Work extends Model
{
    ...
    public function enrichment(){ return $this->hasOne(Enrichment::class,'work_id'); }
    public function score(){ return $this->hasOne(CriterionScore::class,'work_id'); }
    public function composite(){ return $this->hasOne(CompositeScore::class,'work_id'); }
}
